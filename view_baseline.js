...
advanced_expl_div = $('<div id="permdialog_advanced_explantion_text">To see a more in-depth overview of permissions, how permissions are inherited, or other advanced settings, click Advanced.</div>')
...
perm_add_user_select = define_new_user_select_field('perm_add_user', 'Add New Group/User', on_user_change = function(selected_user){
...
perm_remove_user_button  = $('<button id="perm_remove_user" class="ui-button ui-widget ui-corner-all">Remove Group/User</button>')
...
let instructions_div = $('<div id="permdialog_instructions" class="section">Click on the boxes below to change the permissions for the selected user.</div>')
...
perm_dialog.append(instructions_div)
